...
if __name__ == '__main__':
  ...
  if sys.platform == 'win32':
    args.append(os.path.join(root_dir, 'all.gyp'))
    common_fn  = os.path.join(root_dir, 'common.gypi')
    options_fn = os.path.join(root_dir, 'options.gypi')
  else:
    args.append(os.path.join(os.path.abspath(root_dir), 'all.gyp'))
    common_fn  = os.path.join(os.path.abspath(root_dir), 'common.gypi')
    options_fn = os.path.join(os.path.abspath(root_dir), 'options.gypi')
