/**
 * node_root_certs.h -- Bundle of CA Root Certificates
 *
 * Certificate data from Mozilla as of: Thu Oct  9 21:08:48 2014
 *
...
#ifndef LUAIO_CRYPTO_ROOT_CERTS
#define LUAIO_CRYPTO_ROOT_CERTS
